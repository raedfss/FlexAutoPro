 ...
 * 
 * ملف رئيسي لصفحة العميل لبحث واستعراض بيانات كمبيوترات الإيرباق
 * 
 * @version     2.0.0
...
// Asegurarse que la sesión ya está iniciada (por airbag-reset.php)
  ...
  <div class="search-container">
    ...
    <form method="GET" action="" class="search-form">
      ...
      <div class="search-actions full-width">
        ...
        <a href="airbag_reset_main.php" class="btn btn-secondary">↺ إعادة تعيين</a>
      </div>
    </form>
  </div>
          ...
          <tbody>
            <?php foreach ($search_results as $result): ?>
              <tr>
                ...
                <td>
                  <a href="airbag_reset_main.php?ecu_id=<?= $result['id'] ?>" class="result-link">
                    عرض التفاصيل
                  </a>
                </td>
              </tr>
